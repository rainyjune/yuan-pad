CREATE TABLE <sysuser> (uid INT(4) AUTO_INCREMENT NOT NULL PRIMARY KEY,username VARCHAR(30) NOT NULL,password CHAR(123) NOT NULL,email varchar(70) NOT NULL,reg_time INT(11) NOT NULL) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci
