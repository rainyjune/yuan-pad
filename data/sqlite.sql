CREATE TABLE <sysuser> (uid INTEGER PRIMARY KEY,username VARCHAR(30) NOT NULL,password CHAR(123) NOT NULL,email varchar(70) NOT NULL,reg_time INT(11) NOT NULL)
