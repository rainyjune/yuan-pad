...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="./themes/<?= $theme ?>/scripts/admin.css" />
  ...
  <body>
    <div class="container">
      <div id="hd">
        <?php if($app->site_close):?><span class="notice"><?= t('OFF_LINE_MODE') ?></span><?php endif;?>
        <a href="index.php"><?= t('HOME') ?></a>&nbsp;
        <a href="index.php?controller=user&amp;action=logout" title="<?= t('LOGOUT') ?>"><?= t('LOGOUT') ?></a>
      </div><!-- header -->
              ...
              <form id="banip_manage" action="index.php?controller=badip&amp;action=update" method="post">
                <table class="table2">
                  ...
                  <tbody>
                    ...
                    <?php }?>
                    <tr>
                      <td colspan='2' align='left'><span class="check_span"><a href="#" id="ip_checkall"><?php echo t('CHECK_ALL');?></a> &nbsp; <a href="#" id="ip_checknone"><?php echo t('CHECK_NONE');?></a> &nbsp;<a href="#" id="ip_checkxor"><?php echo t('CHECK_INVERT');?></a>&nbsp;</span><input type='submit' value='<?php echo t('DELETE_CHECKED');?>' /></td>
                    </tr>
                  </tbody>
                </table>
              </form>
      ...
      <div class="ft">
          Powered by <a href="https://github.com/rainyjune/yuan-pad">YuanPad <?php echo MP_VERSION;?></a>
      </div><!-- footer -->
      <!-- jqModal window -->
    ...
    <script type="text/javascript" src="./themes/<?= $theme ?>/scripts/admin.js"></script>
  </body>
</html>
