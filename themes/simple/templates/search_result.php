        ...
        <div id="bd">
            <div class="yui-g">
                ...
                <table id="main_table">
                    ...
                    <tr>
                        <td><?php echo (int)$m['uid']?$m['b_username']:$m['uname'];?></td>
