...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	      ...
	      if (res.statusCode === 200) {
	        (function () {
	          ...
	          dataProvider.getTranslations(function (res) {
	            if (_this4.isMounted()) {
	              _this4.setState({ translations: res.response, appConfig: siteConfig });
	            }
	            _this4.getUserInfo();
	          });
	        })();
	  ...
	  handleKeywordInput: function handleKeywordInput(searchText) {
	    this.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentStatistics = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.commentListType === 2 ? React.createElement(
	        'a',
	        { href: 'javascript:void(0)', onClick: this.props.onCloseSearch },
	        'Close'
	      ) : '',
	      React.createElement('p', { dangerouslySetInnerHTML: this.rawMarkup() }),
	      !parseInt(this.props.appConfig.page_on) || this.props.commentListType !== 1 ? '' : React.createElement(Pagination, {
	...
	var CommentList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var createCommentNodes = function createCommentNodes(comment) {
	...
	var Comment = React.createClass({
	  ...
	  rawAuthorMarkup: function rawAuthorMarkup() {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.data.reply_content ? React.createElement(Reply, {
	        appConfig: this.props.appConfig,
	...
	var Captcha = React.createClass({
	  displayName: 'Captcha',
	  refreshCaptch: function refreshCaptch(e) {
	    e.preventDefault();
	    this.refresh();
	  },
	...
	var CommentForm = React.createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    dataProvider.createPost({ user: author, content: text, valid_code: valid_code }, function (res) {
	      if (res.statusCode !== 200) {
	        alert(res.response);
	        return;
	      }
	      _this2.refs.captcha && _this2.refs.captcha.refresh();
	      // Clear the text in the textarea.
	      _this2.setState({ text: '' });
	      _this2.props.onCommentCreated();
	    });
	    return false;
	  },
	  ...
	  handleCaptchaChange: function handleCaptchaChange(e) {
	    this.setState({ valid_code: e.target.value });
	  },
	  render: function render() {
	    return React.createElement(
	      'form',
	      { onSubmit: this.handleSubmit, className: 'commentForm form-horizontal' },
	      React.createElement(
	        'div',
	        { className: 'form-group' },
	        React.createElement(
	      ...
	      this.props.appConfig.valid_code_open == 1 ? React.createElement(Captcha, {
	        ref: 'captcha',
	...
	var CommentBox = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(CommentList, (0, _extends3.default)({}, props, {
	        data: this.props.comments,
	        searchText: this.props.searchText
	      })),
	      React.createElement(CommentStatistics, (0, _extends3.default)({}, props, {
	      ...
	      this.props.commentListType !== 1 ? '' : React.createElement(CommentForm, (0, _extends3.default)({}, props, {
	        ref: 'commentForm',
	        ...
	        switch (_this.props.user.user_type) {
	          case "regular":
	            return React.createElement(
	              'div',
	              null,
	              React.createElement(UpdateUser, props),
	              React.createElement(SignOutButton, props)
	            );
	          case "admin":
	            return React.createElement(SignOutButton, props);
	          case "guest":
	          default:
	            return React.createElement(
	              'div',
	              null,
	              React.createElement(SignIn, props),
	              ' ',
	...
	var SignIn = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        Modal,
	        { isOpen: state.modalIsOpen, onRequestClose: this.closeModal, style: customStyles },
	        React.createElement(
	          'p',
	          null,
	          state.errorMsg
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SignUp = React.createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    dataProvider.signUp({ user: user, pwd: pwd, email: email }, function (res) {
	      if (_this.isMounted()) {
	        if (res.statusCode !== 200) {
	          _this.setState({ errorMsg: res.response });
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserUpdate = React.createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    dataProvider.updateUser({ uid: uid, user: user, pwd: pwd, email: email }, function (res) {
	      if (_this.isMounted()) {
	        if (res.statusCode === 200) {
	          _this.setState({ errorMsg: '', modalIsOpen: false });
	          _this.props.onCurrentUserUpdated(res.response);
	...
	var LogoutButton = React.createClass({
	  ...
	  handleSignOut: function handleSignOut(e) {
	    ...
	    dataProvider.signOut(function () {
	      _this.props.onCurrentUserUpdated({});
	    });
	  },
	  render: function render() {
	    return React.createElement(
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        " ",
	        React.createElement("span", { dangerouslySetInnerHTML: this.ACPMarkup() })
	      ),
	      React.createElement(
	        "p",
	        null,
	        ...
	        React.createElement(
	          "a",
	          { href: "https://github.com/rainyjune/yuan-pad", target: "_blank", title: "Find More" },
	          "YuanPad"
	        ),
	        " ",
	        React.createElement(
	          "a",
	          { href: "index.php?action=rss" },
	          React.createElement("img", { src: "misc/images/rss-icon.png", alt: "rss" })
	        )
	      )
	    );
	  }
