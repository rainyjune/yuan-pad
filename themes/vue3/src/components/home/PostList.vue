...
// const emit = defineEmits({currentPageChanged: (value: number) {
//   emit(value)
// }});
...
function onCurrentPageChanged(value: number) {
  emit('currentPageChanged', value);
}
</script>
...
<template>
  <div class="greetings">
    ...
    <el-pagination layout="prev, pager, next" :total="count" :page-size="pageSize" @current-change="onCurrentPageChanged" />
  </div>
</template>
