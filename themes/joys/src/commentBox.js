  ...
  render() {
    return (
      <div className="statistics">
        {(this.props.commentListType === 2) ? <a href="#" onClick={(e) => { e.preventDefault(); this.props.onCloseSearch(); }}>Close</a> : ''}
      ...
      <form onSubmit={this.handleSubmit} className="commentForm form-horizontal" >
        ...
        <div className="form-group">
          <div className="col-sm-offset-2 col-sm-10 col-lg-offset-2 col-lg-10">
            <button className="btn btn-default" id="postCommentSubmit" type="submit">{this.props.lang.SUBMIT}</button>
          </div>
        </div>
      </form>
    );
