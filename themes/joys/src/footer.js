    ...
    return (
      <footer>
        <p>
          ...
          <a href={"mailto:" + this.props.appConfig.admin_email} className='css-links'>{this.props.lang.ADMIN_EMAIL}</a>&nbsp;
          <span dangerouslySetInnerHTML={this.ACPMarkup()}></span>
        </p>
        <p>
          Powered by <a href="https://github.com/rainyjune/yuan-pad" target="_blank" title="Find More" className='css-links'>YuanPad</a>&nbsp;
